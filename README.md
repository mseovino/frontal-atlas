...
| `cyclogenesis.py`, `cyclogenesis_check.py`, `cyclogenesis_figs.py` | Cool-season genesis zones and bomb cyclones from analysed lows in WPC's area, following Fritzen et al. (2021, JAMC); the check tests whether each zone deepens like real genesis |
