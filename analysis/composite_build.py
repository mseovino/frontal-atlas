...
STRATA = {
    ...
    "deep": lambda d: d.pressure_hpa <= T1,
    "moderate": lambda d: (d.pressure_hpa > T1) & (d.pressure_hpa <= T2),
    "weak": lambda d: d.pressure_hpa > T2,
}
...
print("saved norwegian_composite.npz")
